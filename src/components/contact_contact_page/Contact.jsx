    ...
    return (
        <div className='px-5 max-w-[1560px] min-h-screen mx-auto pt-20 py-10'>
            ...
            <div className=" text-white font-semibold text-[32px] mt-12">
                ...
                contacts</div>
            {/* h2 title */}
            <div className=" text-white mt-[14px] mb-[46px]">How do you reach me?</div>
            {/* flex main */}
            <div className="flex justify-between flex-wrap gap-10">
                ...
                <div className=" flex gap-3">
                    ...
                    <div className=" p-4 border border-[#ABB2BF]">
                        ...
                        <span className='text-[#ABB2BF]'>PayPal.Me/ArseneMuvunyi</span>
                    </div>
                    {/* 2 */}
                    <div className=" p-4 border border-[#ABB2BF]">
                        ...
                        <div className=" text-[#ABB2BF]">
                            ...
                            <div className=" flex gap-1 items-center">
                                ...
                                {/* text */}
                                <span>arsenemuvunyi27@gmail.com</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className=" mt-6 mb-5x">
                {/* title */}
                <div className=" text-[32px] font-medium text-white"><span className='text-[#C778DD]'>#</span>other-media</div>
                {/* media */}
